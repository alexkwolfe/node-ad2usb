...
(function() {
  var Alarm, BufferStream, EventEmitter, Socket, pad,
  ...
  Alarm = (function(_super) {
    ...
    */
    ...
    Alarm.prototype.handlePanelData = function(msg) {
      var armedAway, armedStay, beeps, disarmed, parts, sec1, sec2, sec3;
      parts = msg.split(',');
    ...
    */
    ...
    Alarm.prototype.handleRfMessage = function(msg) {
      ...
      return this.state("loop:" + serial + ":3", status.loop3, this.state("loop:" + serial + ":4", status.loop4));
    };
    ...
    */
    ...
    Alarm.connect = function() {
      ...
      ip = args.shift();
      port = (_ref = args.shift()) != null ? _ref : 4999;
      socket = new Socket({
        type: 'tcp4'
      });
